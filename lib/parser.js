...
const HEX_TABLE = new Uint8Array(256);
HEX_TABLE.fill(0xff);
...
// a-f
for (let i = 0xa; i <= 0xf; i += 1) {
  HEX_TABLE[0x61 + i - 0xa] = i;
}
...
export default class Parser {
  ...
  parseName(chunk, offset) {
    ...
    this.strParts.push(chunk.subarray(offset, newOffset));
